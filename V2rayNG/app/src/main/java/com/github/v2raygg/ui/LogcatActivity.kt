...
import com.github.v2raygg.databinding.ActivityLogcatBinding
...
import com.github.v2raygg.viewmodel.LogcatViewModel
    ...
    private fun shareLogcat() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val result = try {
                ...
                val logFile = File(shareDir, "v2raygg_logcat_$timestamp.txt")
